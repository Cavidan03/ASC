...
$sql2 = $db->prepare("SELECT * FROM `esas_sehife`");
$sql2->execute();
$d = $sql2->fetch(PDO::FETCH_ASSOC);
?>
<style>
  * {
    margin: 0;
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu text-dark" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item text-dark active" href="idare_heyet.php">İdarə heyəti</a>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <span>
            ...
            <i class="fa-solid fa-angle-right"></i> İdarə heyəti
          </span>
        </div>
      </div>
    </div>
  ...
  <div class="content">
    ...
    <div class="altcontent">
      <div class="row1">
        <div class="heading">
          <h2> Aqrar Müştərək Sığorta Şirkətinin <em>İdarə Heyəti</em></h2>
        </div>
        <p>Aqrar Müştərək Sığorta Şirkətinin İdarə Heyəti</p>
        <div class="team">
          <?php
