...
if (isset($_POST['upload'])) {
    ...
    if (isset($_POST['upload'])) {
        ...
        if (move_uploaded_file($tmp_name, $pic)) {
            $sql = $db->prepare('INSERT INTO `idare_heyet` (`id`, `sekil`, `ad`, `hazirki_vezife`, `e-mail`) VALUES (NULL, ?, ?, ?, ?)');
            $catch = [
                "assets/img/$name",
                $_POST['ad'],
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-8 me-7">
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="idare_heyet">İdarə
                            Heyətyi</a>
                    </li>
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Əlavə et</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Əlavə et</h6>
            </nav>
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-2">
                            <h6 class="text-white text-capitalize ps-4">Əlavə et</h6>
                        </div>
                    </div>
                            ...
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-4">
                                    <div class="input-group input-group-lg input-group-outline my-5">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="ad" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    <div class="input-group input-group-lg input-group-outline my-5">
                                        <label class="form-label">E-maili</label>
                                        <input type="text" class="form-control form-control-lg" name="e-mail" required>
                                    </div>
                                </div>
