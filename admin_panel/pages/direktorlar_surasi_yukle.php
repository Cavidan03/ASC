...
if (isset($_POST['upload'])) {
    ...
    if (isset($_POST['upload'])) {
        ...
        if (move_uploaded_file($tmp_name, $pic)) {
            $sql = $db->prepare('INSERT INTO `direktorlar_surasi` (`id`, `sekil`, `ad`, `hazirki_vezife`, `e-mail`) VALUES (NULL, ?, ?, ?, ?)');
            $catch = [
                "assets/img/$name",
                $_POST['ad'],
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-8 me-7">
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Direktorlar Şurası</a>
                    </li>
